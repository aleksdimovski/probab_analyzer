...
sig
  ...
  val to_stringYices : var list -> t -> string
...
struct
  ...
  let to_stringYices vars c =
    ...
    first := true;
    (match Lincons1.get_typ c with
     | Lincons1.EQ -> str := "(assert (= " ^ !str; aux k "" ""; str := !str ^ "))"; !str
     | Lincons1.SUPEQ -> str := "(assert (>= " ^ !str; aux k "" ""; str := !str ^ "))"; !str
     | Lincons1.SUP -> str := "(assert (> " ^ !str; aux k "" ""; str := !str ^ "))"; !str
     | Lincons1.DISEQ -> raise (Invalid_argument "print:DISEQ")
     | Lincons1.EQMOD s -> raise (Invalid_argument "print:EQMOD"))
